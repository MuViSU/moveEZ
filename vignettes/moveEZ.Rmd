...
The line plot shows that the biplot of 2000 results in a lower CC and larger PS value compared to the other years. This means that there is a noticeable difference between the year 2000 and the average across years and the measurements of variables should be investigated in more detail for this year to understand the difference.
...
The line plot shows that the initially the bias is low, but increases and stabilises from 1960 with a slight increase in the AMB for 2000. The MB stays constant and close to zero for all comparisons.
